...
class OnlinePayFromStafController extends Controller
{
    ...
    public function oPayFStafPayAllRes(Request $req){
        ...
        $payload = array(
            ...
            'ReturnUrls' => array(
                'Success' => "https://qrorpa.ch/oPayFStafPayAllResRegOrd/?OPR=".$OnlinePayRegister2,
    ...
    public function oPayFStafPaySelectedRes(Request $req){
        ...
        $payload = array(
            ...
            'ReturnUrls' => array(
                'Success' => "https://qrorpa.ch/oPayFStafPaySelectedResRegOrd/?OPR=".$OnlinePayRegister2,
                'Fail' => "https://qrorpa.ch/?Res=".$oPForCl->resId."&t=".$oPForCl->tableNr
            ),
            'Notification' => array(
                'PayerEmail' => "erikthaqi1@amail.com",
    ...
    public function oPayFStafPayTakeaway(Request $req){
        ...
        $payload = array(
            ...
            'ReturnUrls' => array(
                'Success' => "https://qrorpa.ch/oPayFStafPayTakeawayRegOrd/?OPR=".$OnlinePayRegister2,
                'Fail' => "https://qrorpa.ch/?Res=".$oPForCl->resId."&t=".$oPForCl->tableNr
            ),
            'Notification' => array(
                'PayerEmail' => "erikthaqi1@amail.com",
