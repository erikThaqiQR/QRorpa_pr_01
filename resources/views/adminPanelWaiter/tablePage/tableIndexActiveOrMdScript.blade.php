<script>
    ...
    function prepTableChangeModal(tableId,tableNr,tableTab){
        ...
        $.ajax({
			url: '{{ route("resTablePage.tablePageTableChangeFetchClientsWaiter") }}',
			method: 'post',
			data: {
				tTab: tableTab,
				tId: tableId,
			...
			success: (response) => {
                ...
                if(response == ''){
                    ...
                    $.ajax({
						url: '{{ route("resTablePage.tablePageTableChangeFetchTablesWaiter") }}',
						method: 'post',
						data: {
							_token: '{{csrf_token()}}'
						},
						success: (allTableDt) => {
                            ...
                            $.each(allTableDt.split('--||--'), function( index, tblOneDt ) {
                                ...
                                if(tblOneDt2D[1] == tableNr){
                                    $('#adminChangeTableModalTablesShow').append('<div class="adminChangeTableNotSelect mb-2" id="adminChangeTableDiv'+tblOneDt2D[1]+'" style="width:9.5%; margin-right:0.25%; margin-left:0.25%;" disabled>'+
                                    ...
                                    if(tblOneDt2D[2] != 0){
                                        $('#adminChangeTableModalTablesShow').append('<div class="adminChangeTableNotSelect mb-2 btn" id="adminChangeTableDiv'+tblOneDt2D[1]+'" style="width:9.5%; margin-right:0.25%; margin-left:0.25%; padding:0;"'+
