...
@include('adminPanelWaiter.tablePage.splitTheBill')
@include('adminPanelWaiter.tablePage.splitTheBillRechnung')
...
@include('adminPanelWaiter.tablePage.tableIndexActiveOrMdScript')
@include('adminPanelWaiter.tablePage.tableIndexPayAllCode')
@include('adminPanelWaiter.tablePage.tableIndexPaySelectedCode')
@include('adminPanelWaiter.tablePage.billTabletModal')