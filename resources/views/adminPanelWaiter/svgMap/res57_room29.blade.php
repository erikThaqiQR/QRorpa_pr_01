<?php
  ...
  $svgObjAllK = svgTableMapData::where([['toRes','57'],['toRoom','29'],['formShape','k']])->get();
  $svgObjAllRR = svgTableMapData::where([['toRes','57'],['toRoom','29'],['formShape','rr']])->get();
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="{{$svgBoxSize1}} {{$svgBoxSize2}} {{$svgBoxSize3}} {{$svgBoxSize4}}">
  ...
  <rect x="256.828" y="14.442" width="104.866" height="43.328" style="fill: rgb(216, 216, 216); stroke: rgb(0, 0, 0);" id="block1"/>
  <rect x="123.705" y="416.954" width="388.069" height="38.933" style="fill: rgb(216, 216, 216); stroke: rgb(0, 0, 0);" id="block2"/>
  <rect x="9.419" y="351.648" width="101.099" height="36.421" style="fill: rgb(216, 216, 216); stroke: rgb(0, 0, 0); transform-box: fill-box; transform-origin: 50% 50%;" transform="matrix(0.707107, 0.707107, -0.707107, 0.707107, -4.395649, 26.373709)" id="block3"/>
  <rect x="590.895" y="234.223" width="64.05" height="121.193" style="fill: rgb(216, 216, 216); stroke: rgb(0, 0, 0);" id="block4"/>

  <text style="white-space: pre; fill: rgb(51, 51, 51); font-family: Arial, sans-serif; font-size: 28px;" x="290.737" y="445.212">Bar</text>
  <text style="white-space: pre; fill: rgb(51, 51, 51); font-family: Arial, sans-serif; font-size: 28px;" x="287.598" y="45.84">Tür</text>
  <text style="white-space: pre; fill: rgb(51, 51, 51); font-family: Arial, sans-serif; font-size: 28px; transform-box: fill-box; transform-origin: 50% 50%;" x="158.242" y="190.267" transform="matrix(0.707107, 0.707107, -0.707107, 0.707107, -143.171109, 214.128804)">Küche</text>
  <text style="fill: rgb(51, 51, 51); font-family: Arial, sans-serif; font-size: 20px; white-space: pre; transform-box: fill-box; transform-origin: 69.9934% 70.2701%;" transform="matrix(0, -1, 1, 0, 1103.244919, 522.36617)" x="-555.68" y="-249.24">Wintergarten</text>
