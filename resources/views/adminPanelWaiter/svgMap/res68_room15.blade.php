<?php
  ...
  $svgObjAllK = svgTableMapData::where([['toRes','68'],['toRoom','15'],['formShape','k']])->get();
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="{{$svgBoxSize1}} {{$svgBoxSize2}} {{$svgBoxSize3}} {{$svgBoxSize4}}">
    ...
    @endforeach  
     ...
     <rect x="1220.99" y="326.684" width="182.82" height="266.093" style="stroke: rgb(0, 0, 0); stroke-width: 0px; fill: rgb(87, 87, 87);" id="block1"/>
</svg>
