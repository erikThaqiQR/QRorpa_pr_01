<?php
  ...
  $svgObjAllK = svgTableMapData::where([['toRes','44'],['toRoom','18'],['formShape','k']])->get();
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="{{$svgBoxSize1}} {{$svgBoxSize2}} {{$svgBoxSize3}} {{$svgBoxSize4}}">
  ...
  <text style="fill: rgb(255, 255, 255); font-family: Arial, sans-serif; font-size: 40px; white-space: pre;" x="49.34" y="80.558" transform="matrix(1.239154, 0, 0, 1.449618, -4.789542, -8.180814)">Tür</text>
</svg>
