<?php
  ...
  $svgObjAllK = svgTableMapData::where([['toRes','69'],['toRoom','11'],['formShape','k']])->get();
  $svgObjAllRR = svgTableMapData::where([['toRes','69'],['toRoom','11'],['formShape','rr']])->get();

  if(!$agent->isMobile()){
    $svgBoxSize1 = -277.226;
    $svgBoxSize2 = 0;
    $svgBoxSize3 = 1321.243;
    $svgBoxSize4 = 527.083;
  }else{
    $svgBoxSize1 = 6.098;
    $svgBoxSize2 = 0;
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="{{$svgBoxSize1}} {{$svgBoxSize2}} {{$svgBoxSize3}} {{$svgBoxSize4}}">
  ...
  <rect x="606.679" y="369.337" width="151.389" height="12.5" style="stroke: rgb(0, 0, 0); fill: rgb(163, 207, 239);"/>
  <rect x="606.679" y="339.475" width="90.972" height="12.5" style="stroke: rgb(0, 0, 0); fill: rgb(163, 207, 239); stroke-width: 1;"/>
