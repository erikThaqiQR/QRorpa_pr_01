    ...
    function prepPaySelProds(tNr,resId){
        ...
        $.ajax({
            ...
            success: (respo) => {
                ...
                $('#payAllPhaseOneDiv1Sel').append('<p style="width: 50%; margin-bottom:8px;" class="text-left"><strong>Total inkl.</strong></p>');
                $('#payAllPhaseOneDiv1Sel').append('<p style="width: 50%; margin-bottom:8px;" class="text-right"><strong>CHF <span id="totAmProdsSel">'+parseFloat(totPay).toFixed(2)+'</span></strong></p>');
                $('#payAllPhaseOneDiv1Sel').append('<p id="payAllPhaseOneDiv1TippPSel11" style="width: 50%; margin-top:-8px; margin-bottom:8px;" class="text-left"><strong>Tipp.</strong></p>');
                $('#payAllPhaseOneDiv1Sel').append('<p id="payAllPhaseOneDiv1TippPSel12" style="width: 50%; margin-top:-8px; margin-bottom:8px;" class="text-right"><strong>CHF <span id="tippAmProdsSel">0.00</span></strong></p>');
                $('#payAllPhaseOneDiv1Sel').append('<p id="payAllstaffDiscountShowSel01" style="width: 50%; margin-top:-8px; margin-bottom:8px;" class="text-left"><strong>Rabatt vom Personal.</strong></p>');
                $('#payAllPhaseOneDiv1Sel').append('<p id="payAllstaffDiscountShowSel02" style="width: 50%; margin-top:-8px; margin-bottom:8px;" class="text-right"><strong>CHF <span id="staffDiscSpanSel">0.00</span></strong></p>');
                $('#payAllPhaseOneDiv1Sel').append('<p id="payAllgiftCardDiscountShowSel01" style="width: 50%; margin-top:-8px; margin-bottom:8px;" class="text-left"><strong>Rabatt von der Geschenkkarte.</strong></p>');
                $('#payAllPhaseOneDiv1Sel').append('<p id="payAllgiftCardDiscountShowSel02" style="width: 50%; margin-top:-8px; margin-bottom:8px;" class="text-right"><strong>CHF <span id="giftCardDiscSpanSel">0.00</span></strong></p>');
                $('#payAllPhaseOneDiv1Sel').append('<p style="width: 50%; margin-top:-8px; margin-bottom:8px;" class="text-left"><strong>MwSt.</strong></p>');
                if($('#resTvshInput').val() == 0){
                    $('#payAllPhaseOneDiv1Sel').append('<p style="width: 50%; margin-top:-8px; margin-bottom:8px;" class="text-right"><strong>CHF <span id="tvshAmProdsSel">'+parseFloat(0).toFixed(2)+'</span> (<span id="tvshAmProdsPerventageSel">0.00</span> %)</strong></p>');
                }else{
                    $('#payAllPhaseOneDiv1Sel').append('<p style="width: 50%; margin-top:-8px; margin-bottom:8px;" class="text-right"><strong>CHF <span id="tvshAmProdsSel">'+parseFloat(mwst).toFixed(2)+'</span> (<span id="tvshAmProdsPerventageSel">8.10</span> %)</strong></p>');
                }
                $('#payAllPhaseOneDiv1Sel').append('<p id="payAllFinalPayShowSel01" style="width: 50%; margin-top:-8px; margin-bottom:8px; font-size:1.1rem;" class="text-left"><strong>Letzte Bezahlung.</strong></p>');
                $('#payAllPhaseOneDiv1Sel').append('<p id="payAllFinalPayShowSel02" style="width: 50%; margin-top:-8px; margin-bottom:8px; font-size:1.1rem;" class="text-right"><strong>CHF <span id="finalPaySpanSel">'+parseFloat(totPay).toFixed(2)+'</span></strong></p>');
