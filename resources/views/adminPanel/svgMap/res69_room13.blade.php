<?php
  ...
  $svgObjAllK = svgTableMapData::where([['toRes','69'],['toRoom','13'],['formShape','k']])->get();

  if(!$agent->isMobile()){
    $svgBoxSize1 = -455.986;
    $svgBoxSize2 = 0;
    $svgBoxSize3 = 1456.876;
    $svgBoxSize4 = 500;
  }else{
    $svgBoxSize1 = 0;
    $svgBoxSize2 = 0;
    ...
    <g id="tableIconDiv{{$svgObjOne->tableNr}}">
      ...
      @if($tabelOne->kaTab != 0 )
        @if($tabelOne->kaTab == -1)
          ...
          style="white-space: pre; fill: rgb(51, 51, 51); font-family: Arial, sans-serif; font-size: 24px;" 
          x="{{$xtableNr}}" y="{{$ytableNr}}">Kunde {{$kundeNr}}</text>
