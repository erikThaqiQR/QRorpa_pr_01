<?php
  ...
  $svgObjAllK = svgTableMapData::where([['toRes','68'],['toRoom','10'],['formShape','k']])->get();
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="{{$svgBoxSize1}} {{$svgBoxSize2}} {{$svgBoxSize3}} {{$svgBoxSize4}}">
    ...
    <rect x="285.327" y="95.196" width="90.854" height="204.421" style="stroke: rgb(70, 70, 70); fill: rgb(104, 104, 104);" id="block01"/>
</svg>
