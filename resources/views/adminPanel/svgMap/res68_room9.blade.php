<?php
  ...
  $svgObjAllK = svgTableMapData::where([['toRes','68'],['toRoom','9'],['formShape','k']])->get();
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="{{$svgBoxSize1}} {{$svgBoxSize2}} {{$svgBoxSize3}} {{$svgBoxSize4}}">
    ...
    @foreach($svgObjAllK as $svgObjOne)
        ...
        @if($tabelOne->kaTab != 0 )
            ...
            x="{{$xtableObj}}" y="{{$ytableObj}}" width="{{$wtableObj}}" height="{{$htableObj}}"
    ...
    <rect x="193.969" y="103.879" width="95" height="465.281" style="stroke: rgb(0, 0, 0); stroke-width: 1; fill: rgb(56, 56, 56);" id="block1"/>
    <rect x="416.204" y="104.934" width="95" height="465.281" style="stroke: rgb(0, 0, 0); stroke-width: 1; fill: rgb(56, 56, 56);" id="block2"/>
    <rect x="640.598" y="106.083" width="95" height="465.281" style="stroke: rgb(0, 0, 0); stroke-width: 1; fill: rgb(56, 56, 56);" id="block3"/>
    <rect x="976.007" y="108.618" width="95" height="465.281" style="stroke: rgb(0, 0, 0); stroke-width: 1; fill: rgb(56, 56, 56);" id="block4"/>
</svg>
