<?php
  ...
  $svgObjAllK = svgTableMapData::where([['toRes','60'],['toRoom','33'],['formShape','k']])->get();
  $svgObjAllRR = svgTableMapData::where([['toRes','60'],['toRoom','33'],['formShape','rr']])->get();
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="{{$svgBoxSize1}} {{$svgBoxSize2}} {{$svgBoxSize3}} {{$svgBoxSize4}}">
  ...
  <rect x="238.932" y="227.117" width="42" height="42" style="stroke: rgb(0, 0, 0); stroke-width: 0; fill: rgb(103, 246, 77);" rx="3" ry="3" id="block3"/>
  <rect x="-0.181" y="64.736" width="48.514" height="6.671" style="stroke: rgb(0, 0, 0); fill: rgb(103, 246, 77); stroke-width: 0px;" rx="2" ry="2" id="block2"/>
  <rect x="83.462" y="-0.537" width="6.7" height="67.116" style="stroke: rgb(0, 0, 0); fill: rgb(103, 246, 77); stroke-width: 0;" rx="2" ry="2" id="block1"/>
