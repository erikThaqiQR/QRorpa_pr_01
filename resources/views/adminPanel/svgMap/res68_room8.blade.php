<?php
  ...
  $svgObjAllK = svgTableMapData::where([['toRes','68'],['toRoom','8'],['formShape','k']])->get();
  $svgObjAllRR = svgTableMapData::where([['toRes','68'],['toRoom','8'],['formShape','rr']])->get();

  if(!$agent->isMobile()){
    $svgBoxSize1 = 0;
    $svgBoxSize2 = 0;
    $svgBoxSize3 = 1403.121;
    $svgBoxSize4 = 822.651;
  }else{
    $svgBoxSize1 = 0;
    $svgBoxSize2 = 0;
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="{{$svgBoxSize1}} {{$svgBoxSize2}} {{$svgBoxSize3}} {{$svgBoxSize4}}">
  ...
  <rect x="789.163" y="109.476" width="110" height="113.054" style="stroke: rgb(0, 0, 0); stroke-width: 1; fill: rgb(61, 61, 61);" id="block01"/>
  <rect x="462.254" y="672.668" width="481.561" height="150.84" style="stroke: rgb(0, 0, 0); stroke-width: 1; fill: rgb(61, 61, 61);" id="block02"/>
