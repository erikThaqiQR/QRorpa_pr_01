<?php
  ...
  $svgObjAllK = svgTableMapData::where([['toRes','60'],['toRoom','34'],['formShape','k']])->get();
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="{{$svgBoxSize1}} {{$svgBoxSize2}} {{$svgBoxSize3}} {{$svgBoxSize4}}">
  ...
  <rect x="13.084" y="61.535" width="12.554" height="121.739" style="stroke: rgb(0, 0, 0); stroke-width: 0px; fill: rgb(100, 100, 100);" rx="1" ry="1" id="block1"/>
  <rect x="136.5" y="23.026" width="125.542" height="12.554" style="stroke: rgb(0, 0, 0); stroke-width: 0; fill: rgb(100, 100, 100);" rx="1" ry="1" id="block2"/>
  <rect x="250.546" y="23.739" width="12.554" height="43.464" style="stroke: rgb(0, 0, 0); stroke-width: 0; fill: rgb(100, 100, 100);" rx="1" ry="1" id="block3"/>
  <rect x="309.552" y="189.681" width="17.576" height="17.576" style="stroke: rgb(0, 0, 0); stroke-width: 0; fill: rgb(100, 100, 100);" rx="1" ry="1" id="block4"/>
  <rect x="387.509" y="265.094" width="17.576" height="17.576" style="stroke: rgb(0, 0, 0); stroke-width: 0; fill: rgb(100, 100, 100);" rx="1" ry="1" id="block5"/>
