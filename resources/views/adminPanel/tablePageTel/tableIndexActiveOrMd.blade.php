        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-header d-flex justify-content-between" style="width:100%;">
                    ...
                    <button style="width: 20%;" type="button" class="mt-2 btn btn-outline-dark shadow-none" data-dismiss="modal"><i class="fa-solid fa-xmark"></i></button>
                </div>
                                                ...
                                                @endif
                                                    <div style="width:100%;">
                                                        ...
                                                        <p class="d-flex justify-content-between" style="font-size:15px; margin-bottom:3px;">
                                                            <span style="width:66%;">{{$time2D[0]}}:{{$time2D[1]}} Uhr</span>
...
@include('adminPanel.tablePageTel.tableIndexActiveOrMdScript')
