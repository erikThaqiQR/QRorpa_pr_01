...
style="background-color: rgba(0, 0, 0, 0.5); padding-top:4%;">
    <div class="modal-dialog modal-xl split-bill-tel-modal-dialog">
        <div class="modal-content split-bill-tel-modal-content">
            ...
            <div class="d-flex justify-content-between flex-wrap split-bill-tel-footer-prices">
...
#splitTheBillInitiateModal .split-bill-tel-footer-prices {
    background: #f5f6f7;
    padding: 10px 8px;
    border-top: 1px solid rgba(0, 0, 0, 0.06);
}
@media (max-width: 576px) {
    #splitTheBillInitiateModal .split-bill-tel-footer-prices p {
        width: 100% !important;
...
#splitTheBillInitiateModal .split-bill-client-card .split-bill-client-head {
    display: flex;
    align-items: flex-start;
    gap: 16px;
}
...
#splitTheBillInitiateModal .split-bill-guest-row {
    margin-bottom: 8px;
}
#splitTheBillInitiateModal .split-bill-guest-avatar-wrap {
    position: relative;
    width: 48px;
    height: 48px;
    border-radius: 14px;
...
#splitTheBillInitiateModal .split-bill-guest-avatar-icon {
    color: #fff;
    font-size: 1.35rem;
}
#splitTheBillInitiateModal .split-bill-guest-badge {
    position: absolute;
    bottom: -4px;
    right: -4px;
    min-width: 22px;
