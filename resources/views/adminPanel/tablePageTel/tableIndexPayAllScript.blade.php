        ...
        $.ajax({
			...
			success: (respo) => {
                ...
                $.each(respo, function(index, value){
                    if($('#prodShowPayAllPre'+value.prodId).length && (resId == 34 || resId == 57)){
                        ...
                        $.ajax({
                            ...
                            success: (resTransact) => {
                                ...
                                if(resJSON.TrxResult == 0){
                                    ...
                                    registerPayTecErrorData(resTransact,'{{ Auth::user()->sFor }}');
                                }
                            },error: (error) => {
                                registerPayTecErrorData(error,'{{ Auth::user()->sFor }}');
                            }
                        });
                    },error: (error) => {
                        registerPayTecErrorData(error,'{{ Auth::user()->sFor }}');
