...
@if(count($allTables) > 0 )
    ...
    <div style="background-color: rgb(39,190,175); min-height: 50cm;" class="pr-1 pl-1 pt-1" id="cookPanelAll">
        ...
        <div class="alert alert-info text-center mt-2 mb-2 glowAlert" id="newNotificationAlert" style="display: none; font-size:1.4rem; width:100%;">
                                                    ...
                                                    @if($tp2 != NULL)
                                                        ...
                                                        @if($tc2 != NULL && $tc2->forPlate == $plateOne)
                                                            ...
                                                            @if ($has2nAccess == 1)
                                                                ...
                                                                @if ( $thePl != NULL)
                                                                    @if($sas == $sasD)
                                                                    <div onclick="changeStatOrCookNo('{{$rTable}}','{{$plateOne}}','{{$oTOrTP->id}}')" 
