...
<nav id="cookPanelNavBar" style="background-color: rgb(39,190,175);" class="navbar navbar-expand-lg d-flex justify-content-between">
    ...
    <div style="width:100%;" class="d-flex justify-content-between">
        <a style="width:30%; padding-top:6px;" href="#"><img src="storage/images/logo_QRorpa_wh.png" style="width:100%; height:auto;" alt=""></a>
            
        <button style="width:22%; background-color:white; color:rgb(39,190,175); font-size:1.3rem; text-align:center;" class="btn btn-default shadow-none" data-toggle="modal" data-target="#howManyTablesShowModal">
            <strong><i class="fa-solid fa-table-cells"></i> <span class="ml-2">: {{Auth::user()->cookPV2BlShow}}</span></strong>
        </button>
        <button style="width:22%; background-color:white; color:rgb(39,190,175); font-size:1.3rem;" class="btn btn-default shadow-none" data-toggle="modal" data-target="#showPlateColorSelectModal">
            <strong><i class="fa fa-3x-solid fa-palette"></i></strong>
        </button>


        <a style="color: white; width:15%; text-align:right; padding-top:6px; padding-right:8px;"  href="{{ route('logout') }}"
            onclick="event.preventDefault();
            document.getElementById('logout-form').submit();">
            <strong><i class="fa-solid fa-2x fa-right-from-bracket"></i></strong>
        </a>
    ...
    <div class="d-flex justify-content-between" style="width:100%;">
        <a href="{{ route('cookPnl.cookPanelIndexCook') }}" class="text-center pt-1 pb-1 pointerH" style="width:49%; background-color:rgba(191,191,191,255); color:rgba(63,63,63,255); border-radius:5px; font-size:1rem; margin:0px;">
            <strong>Offen</strong>
        </a>
        <a href="{{ route('cookPnl.cookPanelIndexCookNotConf') }}" class="text-center pt-1 pb-1 pointerH" style="width:49%; background-color:rgba(4,178,89,255); color:rgba(63,63,63,255); border-radius:5px; font-size:1rem; margin:0px;">
            <strong>Bereit</strong>
        </a>
    </div>
    @elseif (Request::is('cookPanelIndexCookT') || Request::is('cookPanelIndexCookTNotConf'))
    <div class="d-flex justify-content-between" style="width:100%; ">
        <a href="{{ route('cookPnl.cookPanelIndexCookT') }}" class="text-center pt-1 pb-1 pointerH" style="width:49%; background-color:rgba(191,191,191,255); color:rgba(63,63,63,255); border-radius:5px; font-size:1rem; margin:0px;">
            <strong>Offen</strong>
        </a>
        <a href="{{ route('cookPnl.cookPanelIndexCookTNotConf') }}" class="text-center pt-1 pb-1 pointerH" style="width:49%; background-color:rgba(4,178,89,255); color:rgba(63,63,63,255); border-radius:5px; font-size:1rem; margin:0px;">
            <strong>Bereit</strong>
        </a>
    </div>
    @endif
    ...
    @if(Request::is('cookPanelIndexCookT') || Request::is('cookPanelIndexCookTNotConf') || Request::is('cookPanelIndexCookD'))
        ...
        <a href="{{ route('cookPnl.cookPanelIndexCook') }}" style="width:49%; background-color:red; color:white; font-size:1rem;" class="btn btn-danger mt-2 table-glow-adminAlert">
            <strong>Restaurant</strong>
        </a>
        @else
        <a href="{{ route('cookPnl.cookPanelIndexCook') }}" style="width:49%; background-color:white; color:rgb(39,190,175); font-size:1rem;" class="btn btn-default mt-2">
            <strong>Restaurant</strong>
        </a>
        @endif
    @endif
    ...
    @if(cooksProductSelection::where([['workerId',Auth::user()->id],['contentType','Takeaway']])->first() != NULL && (Request::is('cookPanelIndexCook') || Request::is('cookPanelIndexCookNotConf') || Request::is('cookPanelIndexCookD')))
        ...
        @if(count($allOrdersTA) > 0)
            <a href="{{ route('cookPnl.cookPanelIndexCookT') }}" style="width:49%; background-color:red; color:white; font-size:1rem;" class="btn btn-danger mt-2 table-glow-adminAlert">
                <strong>Takeaway</strong>
            </a>
        @else
            <a href="{{ route('cookPnl.cookPanelIndexCookT') }}" style="width:49%; background-color:white; color:rgb(39,190,175); font-size:1rem;" class="btn btn-default mt-2">
                <strong>Takeaway</strong>
            </a>
        @endif
    @endif
    ...
    <a href="{{ route('cookPnl.cookPanelIndexCookD') }}" style="width:49%; background-color:white; color:rgb(39,190,175); font-size:1rem;" class="btn btn-default mt-2 shadow-none">
        <strong>Delivery</strong>
    </a>
    @endif
    <button style="width:49%; background-color:white; color:rgb(39,190,175); font-size:1rem;" class="btn btn-default shadow-none mt-2" data-toggle="modal" data-target="#settingsModal">
...
<div class="modal" id="settingsModal" tabindex="-1" role="dialog" aria-labelledby="settingsModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="background-color: lightgray;">
            <div class="modal-body d-flex flex-wrap">
                <p style="font-size:1.5rem; width:100%; font-weight:bold; color:rgb(72,81,87);" class="text-center">Druckereinstellungen</p>
